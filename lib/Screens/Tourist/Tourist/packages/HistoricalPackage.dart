...
String apiurlHistorical =
    "http://10.0.2.2:8000/api/getPackages/${ResponseData.userId}/Historical";

class HistoricalPackage extends StatefulWidget {
  @override
  _HistoricalPackageState createState() => _HistoricalPackageState();
}

class _HistoricalPackageState extends State<HistoricalPackage> {
  List data;
  ...
  @override
  void initState() {
    this.getPackagesHistorical(context);
    super.initState();
  }

  void getPackagesHistorical(BuildContext context) async {
    var response = await http.get(Uri.encodeFull(apiurlHistorical),
